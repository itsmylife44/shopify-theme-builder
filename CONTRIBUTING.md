...
| `test/` | Vitest tests for the Studio, the `create-theme` command, the Direction checker, the screenshot script's arguments, parts and Chrome lookup, the accessibility check's arguments and findings, the Section Catalog, the skill-gate hook and the release version |
