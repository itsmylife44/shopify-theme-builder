...
**Done** when every check passes; you have the store address, and its storefront password unless the storefront is open; the Creator approved the store auth; the store decisions are confirmed; the menus are written and the other languages enabled and published; and the Creator has the links for the default language, currency and markets.
