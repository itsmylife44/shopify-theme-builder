...
**Done** when `<theme>` holds the Base Theme with the catalog header, announcement bar, footer, contact page, cart page, search page, blog page, article page and 404 page, the Theme's name, and both locale files of every shop language other than English.
