...
**Done** when `<theme>` holds the Base Theme with the catalog header, announcement bar, footer, contact page, cart page, search page and blog page, the Theme's name, and both locale files of every shop language other than English.
